...
public class PlayerUniqueIdFetcher {

    //Full credits to: https://gist.github.com/Jofkos/d0c469528b032d820f42#file-uuidfetcher-java

    /**
     * Date when name changes were introduced
     *
     * @see PlayerUniqueIdFetcher#getUUIDAt(String, long)
     */
     ...
     * @param name      The name
     * @param timestamp Time when the player had this name in milliseconds
     * @see PlayerUniqueIdFetcher#FEBRUARY_2015
     */
    public static UUID getUUIDAt(String name, long timestamp) {
        ...
        try {
            ...
            PlayerUniqueIdFetcher data = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())), PlayerUniqueIdFetcher.class);
    ...
    public static String getName(UUID uuid) {
        ...
        try {
            ...
            connection.setReadTimeout(5000);
            PlayerUniqueIdFetcher currentNameData = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())), PlayerUniqueIdFetcher.class);
