...
public abstract class AbstractDefaultPerk extends AbstractPerk {
    protected AbstractDefaultPerk(String identifier, String displayName, PerkDescription perkDescription, PerkGuiIcon perkGuiIcon, boolean enabled, Map<String, Object> flags) {
