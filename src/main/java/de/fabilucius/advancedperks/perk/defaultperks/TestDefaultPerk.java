package de.fabilucius.advancedperks.perk.defaultperks;
...
@PerkIdentifier("test_perk_lol")
public class TestDefaultPerk extends AbstractDefaultPerk {
    public TestDefaultPerk(String identifier, String displayName, PerkDescription perkDescription, PerkGuiIcon perkGuiIcon, boolean enabled, Map<String, Object> flags) {
